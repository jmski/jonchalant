# Phase 4 Week-by-Week Execution Plan

> Your complete roadmap for Week 1-8 of Phase 4: Email Foundation → Blog Content → YouTube Channel Launch

---

## Executive Summary

**Phase 4 Goal**: Launch integrated email marketing + content marketing to drive sustainable lead generation and establish authority
...
- Ongoing passive lead generation (email + SEO)

---

## Week 1: Email Foundation Launch
...
- [ ] Finalize PDF (download + test delivery)

**Time investment**: 3-4 hours

**Deliverable**: PDF file of lead magnet ready to upload

**Reference**: [EMAIL_PLATFORM_SETUP_CONVERTKIT.md](./EMAIL_PLATFORM_SETUP_CONVERTKIT.md) — Phase 1
...
- [ ] Set up automation: form submission → Email 1 immediate delivery → Email 2 at +2 days, etc.
- [ ] Create "Weekly Lessons" email list
- [ ] Set up weekly lesson email template

**Time investment**: 3-4 hours

**Deliverable**: Live automation sending welcome emails

**Reference**: [EMAIL_PLATFORM_SETUP_CONVERTKIT.md](./EMAIL_PLATFORM_SETUP_CONVERTKIT.md) — Phase 1-2
...
- [ ] Test: Submit test email → verify Email 1 delivery

**Time investment**: 2-3 hours

**Deliverable**: Live signup forms on website

**Reference**: [EMAIL_PLATFORM_SETUP_CONVERTKIT.md](./EMAIL_PLATFORM_SETUP_CONVERTKIT.md) — Phase 3
...
- [ ] Monitor first signups + replies

**Time investment**: 2-3 hours

**Deliverable**: Live email marketing system receiving first subscribers

---

## Week 2: Blog Post #1 + Continue Email

### Monday: Blog Writing Sprint #1

**Focus**: [PHASE_4_BLOG_CONTENT_OUTLINES.md](./PHASE_4_BLOG_CONTENT_OUTLINES.md) — Pillar 1
...
- [ ] Edit for clarity + tone (Jon's voice)
- [ ] Create featured image (1200x630px)
- [ ] Write meta description (<160 characters)
...
- End with next steps + CTA
- Go back + edit for flow
...
- [ ] Upload to YouTube (unlisted for now, link in blog)
...
- [ ] Create social media content (3-5 pieces):
  ...
  - LinkedIn carousel (4 slides: Key takeaways)
  - Instagram Reel script (30 seconds, posture demo)
  - TikTok script (30 seconds, same content)
- [ ] Schedule posts (stagger across Mon-Wed)
- [ ] Reply to comments + engage

**Time investment**: 3-4 hours

**Deliverable**: Blog + social media promotion live
...
**Deliverable**: First weekly lesson email scheduled
...
- [ ] Adjust next posts based on performance data

**Time investment**: 1-2 hours

---

### Tuesday-Thursday: Blog Writing Sprint #2

**Focus**: [PHASE_4_BLOG_CONTENT_OUTLINES.md](./PHASE_4_BLOG_CONTENT_OUTLINES.md) — Pillar 2
...
- [ ] Record videos (2 recommended):
  ...
  - Before/after voice comparison (~2 minutes, audio + on-screen text)
- [ ] Create downloadable: "30-Day Vocal Presence Challenge" (PDF)
- [ ] Edit, format, create featured image, meta description
- [ ] Create social media assets (3-5 pieces)

**Time investment**: 8-10 hours total

**Deliverable**: Blog post + video + downloadable guide
...
## Week 4: Blog Post #3 + YouTube Channel Setup

### Monday: Blog Post #2 Live + Analytics Check
...
- [ ] Brand channel:
  ...
  - [ ] Write channel description (100 words, include bio + subscription CTA)
  - [ ] Create custom profile picture (matching jonchalant.com branding)
  - [ ] Add channel tabs (About, Videos, Playlists)
  - [ ] Create first playlist: "Executive Presence Fundamentals"

**Time investment**: 3-4 hours

**Deliverable**: Professional YouTube channel with branding

---

### Wednesday-Thursday: Blog Writing Sprint #3

**Focus**: [PHASE_4_BLOG_CONTENT_OUTLINES.md](./PHASE_4_BLOG_CONTENT_OUTLINES.md) — Pillar 3
...
**Deliverable**: Blog post + video + downloadable workbook
...
## Week 5: Blog Post #4 (Shortest Week)
...
### Tuesday-Thursday: Blog Writing Sprint #4

**Focus**: [PHASE_4_BLOG_CONTENT_OUTLINES.md](./PHASE_4_BLOG_CONTENT_OUTLINES.md) — Pillar 4
...
- [ ] Edit, format, featured image, meta description
- [ ] Create social media assets
...
- [ ] Schedule social media
- [ ] Monitor YouTube engagement (comments, watch time)

**Time investment**: 2-3 hours

---

## Week 6: Blog Post #5 + First Campaign Check
...
- [ ] YouTube views: Combined view count?
- [ ] Email replies: Any replies from welcome sequence?
- [ ] Conversions: Any coaching inquiries or program signups?

**Time investment**: 2-3 hours (analysis + adjustments)

---

### Tuesday-Thursday: Blog Writing Sprint #5

**Focus**: [PHASE_4_BLOG_CONTENT_OUTLINES.md](./PHASE_4_BLOG_CONTENT_OUTLINES.md) — Pillar 5
...
## Week 7: Blog Post #6 (Case Study) + Video Script Planning

### Monday: Publish Blog Post #5
...
### Thursday-Friday: Blog Writing Sprint #6

**Focus**: [PHASE_4_BLOG_CONTENT_OUTLINES.md](./PHASE_4_BLOG_CONTENT_OUTLINES.md) — Bonus/Case Study
...
## Week 8: YouTube Channel Momentum + Ongoing Email
...
- [ ] Plan YouTube content strategy:
  - [ ] Identify which blog posts will become YouTube series
  - [ ] Plan bonus content (deeper training not on blog)
  - [ ] Storyboard next 3 videos
- [ ] Email strategy:
  - [ ] Collect data on responses, replies, conversions
  - [ ] Identify which emails drove most engagement
...
- [ ] Reply to email replies (personal relationship building)
- [ ] Create weekly lesson email (based on previous week's blog topic)

**Time investment**: 8-10 hours (planning) + ongoing 5 hours/week
...
- [ ] 5-10 coaching inquiries from email seq
...
- [ ] 50+ internal links (good SEO signals)
...
- [ ] 3 videos published
- [ ] 300+ total views
- [ ] 4+ avg watch time per video (shows quality)
...
**Use this each week to track progress**:
...
- [ ] Blog post drafted && edited
- [ ] Blog video recorded && edited
- [ ] Featured image created
- [ ] Social media content created (3+ pieces)
- [ ] Blog post published
- [ ] Weekly lesson email written && scheduled

### Email Marketing
- [ ] Opened ConvertKit dashboard (check metrics)
- [ ] Open rate: ___% | Click rate: ___% | Replies: ___
- [ ] Responded to all email replies
- [ ] Created/scheduled weekly lesson email

### YouTube (Weeks 4+)
- [ ] Video recorded && edited
- [ ] Video uploaded to YouTube
- [ ] Video embedded in blog post
- [ ] Playlist updated
- [ ] YouTube comments reviewed && responded to

### Promotion
- [ ] Social media scheduled (Mon-Wed)
- [ ] Email sent (or scheduled)
- [ ] Analytics checked && notes taken
```
...
4. [PHASE_4_BLOG_CONTENT_OUTLINES.md](./PHASE_4_BLOG_CONTENT_OUTLINES.md) — 6 blog post outlines + SEO strategy
...
- YouTube (free)
- Blog platform (WordPress, Ghost, Webflow, etc.)
...
1. **Batch similar work**: Write all outlines at once, record all videos in one session
2. **Repurpose content**: One blog post → 1 video + multiple social posts + 1 email
3. **Consistency over perfection**: Published is better than perfect; you can always improve
4. **Monitor + adjust**: Check analytics weekly, notice patterns, double down on what works
5. **Engage your audience**: Reply to all comments, replies, DMs (builds community)
6. **Think long-term**: This 8-week sprint creates 6-12 months of evergreen content + authority
